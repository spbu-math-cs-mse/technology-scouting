...
set CLASSPATH=%APP_HOME%\lib\technology-scouting-all.jar

@rem Execute technology-scouting
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TECHNOLOGY_SCOUTING_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%TECHNOLOGY_SCOUTING_EXIT_CONSOLE%" exit 1
exit /b 1
